    ...
    <div className='h-full w-full mt-[7rem] text-center  justify-center items-center'>
      ...
      <div className="grid h-full grid-cols-2 gap-9 place-items-center my-[5rem]">
        ...
        <div className="h-[100%] w-[40vw] flex flex-col   border-[3px] px-6">
          ...
          <h1 className='mt-9 font-bold text-2xl capitalize'>travellers</h1>
          ...
          <div className='text-left flex items-center space-x-10 my-4'>
            <Link href={'https://travelers-theta.vercel.app/'} target='_blank'>            <button className=' bg-black text-white px-12 py-3 rounded-md text-md font-semibold'>Visit Project</button>
            </Link>
        ...
        <div className="h-[100%] w-[40vw] flex flex-col   border-[3px] px-6">
          <Image className=' h-[30vh] w-full' src={demo} />
          <h1 className='mt-9 font-bold text-2xl capitalize'>Vidiscape</h1>
          <p className='my-3 font-base text-left'>
          ...
          <div className='text-left flex items-center space-x-10 my-4'>
            <Link href={'https://youtube-clone-six-vert.vercel.app/'} target='_blank'>            <button className=' bg-black text-white px-12 py-3 rounded-md text-md font-semibold'>Visit Project</button>
            </Link>
        ...
        <div className="h-[100%] w-[40vw] flex flex-col   border-[3px] px-6">
          <Image className=' h-[30vh] w-full' src={demo} />
          <h1 className='mt-9 font-bold text-2xl capitalize'>WearAble</h1>
          <p className='my-3 font-base text-left'>
          ...
          <div className='text-left flex items-center space-x-10 my-4'>
            <Link href={'https://wearable.onrender.com/'} target='_blank'>            <button className=' bg-black text-white px-12 py-3 rounded-md text-md font-semibold'>Visit Project</button>
            </Link>
